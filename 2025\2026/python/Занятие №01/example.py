...
#Красивый ввод целых чисел через пробел:
i1_begin, i1_end, i2_begin, i2_end = map(int, input().split())
'''
...
if(i1_begin > i1_end):
	...
	i1_begin, i1_end = i1_end, i1_begin
if(i2_begin > i2_end):
	i2_begin, i2_end = i2_end, i2_begin
